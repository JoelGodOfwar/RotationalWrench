...
public class Tags_120 {
	...
	public static final Tag<Material> BUTTONS = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.BAMBOO_BUTTON,  Material.POLISHED_BLACKSTONE_BUTTON,
	...
	public static final Tag<Material> DOORS = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.DARK_OAK_DOOR,	Material.JUNGLE_DOOR,	Material.BAMBOO_DOOR,
			Material.SPRUCE_DOOR,	Material.IRON_DOOR,		Material.CHERRY_DOOR,
	...
	public static final Tag<Material> FENCE_GATES = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.DARK_OAK_FENCE_GATE,	Material.JUNGLE_FENCE_GATE,		Material.CHERRY_FENCE_GATE,
			Material.SPRUCE_FENCE_GATE,		Material.BAMBOO_FENCE_GATE,
	...
	public static final Tag<Material> LOGS = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.STRIPPED_DARK_OAK_LOG,	Material.STRIPPED_JUNGLE_LOG,	Material.CHERRY_LOG,
			Material.STRIPPED_CHERRY_LOG,
			Material.STRIPPED_SPRUCE_LOG,	Material.BAMBOO_BLOCK,			Material.STRIPPED_BAMBOO_BLOCK,
			Material.CRIMSON_STEM,	 		Material.WARPED_STEM,			Material.STRIPPED_CRIMSON_STEM,
			Material.STRIPPED_WARPED_STEM,	Material.MANGROVE_LOG,			Material.STRIPPED_MANGROVE_LOG
	); // 1.16
	...
	public static final Tag<Material> REDSTONE_COMPONENTS = new MaterialSetTag(NamespacedKey.randomKey(),
            ...
            Material.HOPPER,        Material.FURNACE,		Material.CALIBRATED_SCULK_SENSOR,
            Material.DECORATED_POT,	Material.CHISELED_BOOKSHELF
    ); // 1.11
	...
	public static final Tag<Material> SIGNS = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.CRIMSON_SIGN,		Material.WARPED_SIGN,		Material.CHERRY_SIGN,
	...
	public static final Tag<Material> SIGNS2 = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.CRIMSON_WALL_SIGN,		Material.WARPED_WALL_SIGN,		Material.CHERRY_WALL_SIGN,
			Material.BAMBOO_WALL_SIGN
    ); // 1.11
	
	public static final Tag<Material> SIGNS3 = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.CRIMSON_HANGING_SIGN,		Material.WARPED_HANGING_SIGN,		Material.CHERRY_HANGING_SIGN,
			Material.BAMBOO_HANGING_SIGN
    ); // 1.11
	
	public static final Tag<Material> SIGNS4 = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.CRIMSON_WALL_HANGING_SIGN,		Material.WARPED_WALL_HANGING_SIGN,		Material.CHERRY_WALL_HANGING_SIGN,
    ...
    public static final Tag<Material> SLABS = new MaterialSetTag(NamespacedKey.randomKey(),
        	...
        	Material.POLISHED_ANDESITE_SLAB,		Material.DIORITE_SLAB,						Material.CHERRY_SLAB,
    		Material.SANDSTONE_SLAB,				Material.RED_SANDSTONE_SLAB,				Material.BAMBOO_SLAB,
    		Material.BLACKSTONE_SLAB,				Material.POLISHED_BLACKSTONE_SLAB,			Material.POLISHED_BLACKSTONE_BRICK_SLAB,
    		Material.CRIMSON_SLAB,					Material.WARPED_SLAB,						Material.BAMBOO_MOSAIC_SLAB,
    ...
    public static final Tag<Material> STAIRS = new MaterialSetTag(NamespacedKey.randomKey(),
    	...
    	Material.DIORITE_STAIRS,					Material.BAMBOO_STAIRS,						Material.BAMBOO_MOSAIC_STAIRS,
    	Material.BLACKSTONE_STAIRS,					Material.POLISHED_BLACKSTONE_STAIRS,		Material.POLISHED_BLACKSTONE_BRICK_STAIRS,
    	Material.CRIMSON_STAIRS,					Material.WARPED_STAIRS,						Material.CHERRY_STAIRS,
    ...
    public static final Tag<Material> TRAPDOORS = new MaterialSetTag(NamespacedKey.randomKey(),
    		...
    		Material.DARK_OAK_TRAPDOOR,	Material.CHERRY_TRAPDOOR,	Material.BAMBOO_TRAPDOOR,
    		Material.CRIMSON_TRAPDOOR,	Material.WARPED_TRAPDOOR
    ); // 1.16
    
    public static final Tag<Material> WALL = new MaterialSetTag(NamespacedKey.randomKey(),
    		...
    		Material.MOSSY_COBBLESTONE_WALL,	Material.MOSSY_STONE_BRICK_WALL,	Material.POLISHED_BLACKSTONE_WALL,
    		Material.POLISHED_BLACKSTONE_BRICK_WALL,	Material.PRISMARINE_WALL,	Material.SANDSTONE_WALL,
    		Material.RED_SANDSTONE_WALL,	Material.STONE_BRICK_WALL
    );
    ...
    public static final Tag<Material> NO_BUTTONS = new MaterialSetTag(NamespacedKey.randomKey(),
        	...
        	Material.SOUL_CAMPFIRE,			Material.CHAIN,						Material.CHERRY_LEAVES,
    ...
    public static final Tag<Material> NO_TORCH_SIDE = new MaterialSetTag(NamespacedKey.randomKey(),
    		...
    		Material.CYAN_STAINED_GLASS_PANE,			Material.PURPLE_STAINED_GLASS_PANE, 		Material.BLUE_STAINED_GLASS_PANE,
    		Material.BROWN_STAINED_GLASS_PANE,			Material.GREEN_STAINED_GLASS_PANE,			Material.RED_STAINED_GLASS_PANE,
    		Material.BLACK_STAINED_GLASS_PANE,			Material.CHERRY_LEAVES,
    ...
    public static final Tag<Material> NO_TORCH_TOP = new MaterialSetTag(NamespacedKey.randomKey(),
			...
			Material.PLAYER_HEAD,			Material.CREEPER_HEAD,			Material.ZOMBIE_HEAD, 
			Material.SKELETON_SKULL,		Material.WITHER_SKELETON_SKULL, Material.DRAGON_HEAD,
    		Material.BAMBOO,				Material.BAMBOO_SAPLING,		Material.CHERRY_LEAVES
